<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="Product_Sales.register" %>
                    ...
                    <ul>
                        <li>
                            <label class="radio left">
                                <asp:RadioButton ID="RadioMale" GroupName="sex" runat="server" /><i></i>Male</label></li>
                        <li>
                            <label class="radio">
                                <asp:RadioButton ID="RadioFemale" GroupName="sex" runat="server" /><i></i>Female</label></li>
                        <div class="clearfix"></div>
                    </ul>
                </div>
                <div class="col-md-6 account-left">
